        ...
        <div className="max-w-xl w-full text-center space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 space-y-4">
            <p className="text-lg text-gray-700 leading-relaxed">
              Stiamo aggiornando il nostro menu con nuovi prodotti e fornitori selezionati.
            </p>
            <p className="text-gray-600">
              Torneremo presto con piatti ancora pi&ugrave; buoni e salutari. Resta sintonizzato!
            </p>
          </div>
          ...
          <div className="space-y-4">
            <p className="text-gray-600 font-medium">
              Vuoi essere avvisato quando torniamo?
            </p>
            <a
              href="https://wa.me/393478881515?text=Ciao%20Pasto%20Sano,%20vorrei%20essere%20avvisato%20quando%20tornate%20con%20il%20menu"
              target="_blank"
